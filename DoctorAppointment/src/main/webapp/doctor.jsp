	...
	<%HttpSession session1=request.getSession(); %>
	 ...
	 <div class="close-btn">&times;</div>
      ...
      <form action="DoctorDetails" method="post">
     	...
     	<input type="text" placeholder="Enter your username" name="name" value="<%=session1.getAttribute("name")%>" readonly>
     	<label for="">Enter your email</label>
        <input type="email" placeholder="Enter your email" name="mail" value="<%=session1.getAttribute("mail")%>" readonly>
